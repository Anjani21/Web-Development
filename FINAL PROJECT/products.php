    ...
    <div class="container">
        <!-- Jumbotron Header -->
            <div class="jumbotron home-spacer" id="products-jumbotron">
                ...
                <p>We have the best Mobile phone from Biggest Brands for you. <br>No need to hunt around, we have all in one place.</p>
              </center>
            </div>
            <hr>
            <br>
            ...
            <div class="col-sm-9 text-center">
                  ...
                  <!----------------------------------------------------featured phone----------------------------------->
                   <div class="panel panel-default">
                    ...
                    <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <img src="img/am1.jpg" alt="Apple Mobile" >
                                    <div class="caption">
                                        <h3>Apple Phones</h3>
                                        <p>Price: Rs. 136000.00 </p>
                        ...
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <img src="./img/rm1.jpg" alt="realme" >
                                    <div class="caption">
                                        <h3>RealMe Phones</h3>
                    ...
                    <div class="col-sm-4 home-feature">
                        <div class="thumbnail">
                            <img src="./img/sm1.jpg" alt="Samsung">
                                <div class="caption">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <img src="./img/a1.jpg" alt="apple 1" >
                                    <div class="caption">
                                        <h3>Apple 1</h3>
                        ...
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <img src="./img/a2.jpg" alt="apple 2" >
                                    <div class="caption">
                                        <h3>Apple 2</h3>
                                        <p>Price: Rs. 88000.00 </p>
                                                <?php if (!isset($_SESSION['email'])) { ?>
                        ...
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <img src="./img/a3.jpg" alt="apple 3" >
                                    <div class="caption">
                                        <h3>Apple 3</h3>
                                        <p>Price: Rs. 88000.00 </p>
                                                <?php if (!isset($_SESSION['email'])) { ?>
                        ...
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <img src="./img/a4.jpg" alt="Apple 4">
                                    <div class="caption">
                                        <h3>Apple 4</h3>
                    ...
                    <div class="col-sm-4 home-feature">
                        <div class="thumbnail">
                            <img src="./img/a5.jpg" alt="apple 5">
                                <div class="caption">
                                    <h3>Apple 5</h3>
                                        <p>Price: Rs. 60000.00 </p>
                                                <?php if (!isset($_SESSION['email'])) { ?>
                    ...
                    <div class="col-sm-4 home-feature">
                        <div class="thumbnail">
                            <img src="./img/a6.jpg" alt="apple 6">
                                <div class="caption">
                                    <h3>Apple 6</h3>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <img src="./img/r1.jpg" alt="realme 1" >
                                    <div class="caption">
                                        <h3>Realme 1</h3>
                        ...
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <img src="./img/r2.jpg" alt="realme 2" >
                                    <div class="caption">
                                        <h3>Realme 2</h3>
                                        <p>Price: Rs. 65000.00 </p>
                                                <?php if (!isset($_SESSION['email'])) { ?>
                        ...
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <img src="./img/r3.jpg" alt="realme 3" >
                                    <div class="caption">
                                        <h3>Realme 3</h3>
                                        <p>Price: Rs. 65000.00 </p>
                                                <?php if (!isset($_SESSION['email'])) { ?>
                        ...
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <img src="./img/r4.jpg" alt="realme 4">
                                    <div class="caption">
                                        <h3>Realme 4</h3>
                                            <p>Price: Rs. 60000.00 </p>
                                                <?php if (!isset($_SESSION['email'])) { ?>
                    ...
                    <div class="col-sm-4 home-feature">
                        <div class="thumbnail">
                            <img src="./img/r5.jpg" alt="realme 5">
                                <div class="caption">
                                    <h3>Realme 5</h3>
                    ...
                    <div class="col-sm-4 home-feature">
                        <div class="thumbnail">
                            <img src="./img/r6.jpg" alt="realme 6">
                                <div class="caption">
                                    <h3>Realme 6</h3>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <img src="./img/o1.jpg" alt="oneplus 1" >
                                    <div class="caption">
                                        <h3>OnePlus 1</h3>
                        ...
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <img src="./img/o2.jpg" alt="oneplus 2" >
                                    <div class="caption">
                                        <h3>OnePlus 2</h3>
                                        <p>Price: Rs. 36000.00 </p>
                                                <?php if (!isset($_SESSION['email'])) { ?>
                        ...
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <img src="./img/o3.jpg" alt="oneplus 3" >
                                    <div class="caption">
                                        <h3>OnePlus 3</h3>
                                        <p>Price: Rs. 36000.00 </p>
                                                <?php if (!isset($_SESSION['email'])) { ?>
                        ...
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <img src="./img/o4.jpg" alt="oneplus 4">
                                    <div class="caption">
                                        <h3>OnePlus 4</h3>
                    ...
                    <div class="col-sm-4 home-feature">
                        <div class="thumbnail">
                            <img src="./img/o5.jpg" alt="oneplus 5">
                                <div class="caption">
                                    <h3>OnePlus 5</h3>
                    ...
                    <div class="col-sm-4 home-feature">
                        <div class="thumbnail">
                            <img src="./img/o6.jpg" alt="oneplus 6">
                                <div class="caption">
                                    <h3>OnePlus 6</h3>
                   ...
                   <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <img src="./img/x1.jpg" alt="xioami 1" >
                                    <div class="caption">
                                        <h3>Xioami 1</h3>
                                        <p>Price: Rs. 36000.00 </p>
                                                <?php if (!isset($_SESSION['email'])) { ?>
                        ...
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <img src="./img/x2.jpg" alt="xioami 2" >
                                    <div class="caption">
                                        <h3>Xioami 2</h3>
                                        <p>Price: Rs. 36000.00 </p>
                                                <?php if (!isset($_SESSION['email'])) { ?>
                        ...
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <img src="./img/x3.jpg" alt="xioami 3" >
                                    <div class="caption">
                                        <h3>Xioami 3</h3>
                                        <p>Price: Rs. 36000.00 </p>
                                                <?php if (!isset($_SESSION['email'])) { ?>
                        ...
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <img src="./img/x4.jpg" alt="xioami 4">
                                    <div class="caption">
                                        <h3>Xioami 4</h3>
                    ...
                    <div class="col-sm-4 home-feature">
                        <div class="thumbnail">
                            <img src="./img/x5.jpg" alt="xioami 5">
                                <div class="caption">
                                    <h3>Xioami 5</h3>
                    ...
                    <div class="col-sm-4 home-feature">
                        <div class="thumbnail">
                            <img src="./img/x6.jpg" alt="xioami 6">
                                <div class="caption">
                                    <h3>Xioami 6</h3>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <img src="./img/s1.jpg" alt="samsung 1" >
                                    <div class="caption">
                                        <h3>Samsung 1</h3>
                                        <p>Price: Rs. 65000.00 </p>
                                                <?php if (!isset($_SESSION['email'])) { ?>
                        ...
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <img src="./img/s2.jpg" alt="samsung 2" >
                                    <div class="caption">
                                        <h3>Samsung 2</h3>
                                        <p>Price: Rs. 65000.00 </p>
                                                <?php if (!isset($_SESSION['email'])) { ?>
                        ...
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <img src="./img/s3.jpg" alt="samsung 3" >
                                    <div class="caption">
                                        <h3>Samsung 3</h3>
                                        <p>Price: Rs. 65000.00 </p>
                                                <?php if (!isset($_SESSION['email'])) { ?>
                        ...
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <img src="./img/s4.jpg" alt="samsung 4">
                                    <div class="caption">
                                        <h3>Samsung 4</h3>
                                            <p>Price: Rs. 60000.00 </p>
                                                <?php if (!isset($_SESSION['email'])) { ?>
                    ...
                    <div class="col-sm-4 home-feature">
                        <div class="thumbnail">
                            <img src="./img/s5.jpg" alt="samsung 5">
                                <div class="caption">
                                    <h3>Samsung 5</h3>
                                        <p>Price: Rs. 45000.00 </p>
                                                <?php if (!isset($_SESSION['email'])) { ?>
                    ...
                    <div class="col-sm-4 home-feature">
                        <div class="thumbnail">
                            <img src="./img/s6.jpg" alt="samsung 6">
                                <div class="caption">
                                    <h3>Samsung 6</h3>
                                        <p>Price: Rs. 35000.00 </p>
                                                <?php if (!isset($_SESSION['email'])) { ?>
